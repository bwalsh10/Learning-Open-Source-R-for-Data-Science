#' Title of Function: ctt_eval
#'
#' Function applies Classical Test Theory statistics for scale and item evaluation.
#'
#' @param x Must be a data frame or matrix.
#' @return Will return two tables of statistics to evaluate your scale: 1) item-level and 2) scale-level
#' @export
